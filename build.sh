...
CLANG_URL="https://github.com/llvm/llvm-project/releases/download/llvmorg-22.1.0/clang+llvm-22.1.0-armv7a-linux-gnueabihf.tar.gz"
...
case "$KSU" in
  "yes") VARIANT="KSU" ;;
  "resukisu") VARIANT="ReSukiSU" ;; # Fixed to match logic check below
  "no") VARIANT="VNL" ;;
esac
